...
Eigen::Affine3d
NeptuneLocation::ComputeLocalFrameFromLatLong(const double latitude,
...
NeptuneLocation::NeptuneLocation(const std::string &configuration_directory,
  ...
  location::KinamicsOpts kinamaic_opt{options_.rigid_param.kinamics_params.b,
                                      options_.rigid_param.kinamics_params.r,
                                      options_.rigid_param.kinamics_params.nv,
                                      options_.rigid_param.kinamics_params.nw};
  ...
  location_ = location::FustionInterface::CreatFusion(location::FusionOption{
      ...
      location::PoseExtrapolatorEkfOption{
          location::EkfOption{
              options_.rigid_param.imu_instrinsci.nba.x(),
              options_.rigid_param.imu_instrinsci.nbg.x(),
              options_.rigid_param.imu_instrinsci.nba.x(),
              options_.rigid_param.imu_instrinsci.nbg.x(),

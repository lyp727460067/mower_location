...
public:
  ...
  ExtrapolationResult
  ExtrapolatePosesWithGravity(const std::vector<common::Time> &times) override;
...
private:
  ...
  void PredictImu(ImuGpsLocalizer *imu_gps_location,
  ...
  State fused_state_;
  std::unique_ptr<KinamicsInterface> odom_kinamics_;
};
} // namespace location
